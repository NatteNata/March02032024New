...
function Clock() {
    ...
    // new Date();
    // new Date('10-11-2023-UTC');
    // new Date(1234512312371);

    const start = () => {
        // пишут студенты // запустить часы (должно отображаться реальное время, а не +1)
        // сохранить ид таймера (https://learn.javascript.ru/settimeout-setinterval#setinterval)

        const id = setInterval(() => setDate(new Date), 1_000)
    ...
    const stringDateofMonth = date.getDate()
    const stringMonth2digits = date.toLocaleDateString('en-US', {month: '2-digit'})
    const stringFullYear = date.getFullYear()

    const stringDate = `${stringDateofMonth}.${stringMonth2digits}.${stringFullYear}`
